...
@click.command()
@click.option('--exp_name', type=str, default="best!")
@click.option('--mode', type=click.Choice(['run', 'test', 'val', 'test_both'],
										  case_sensitive=False), default="run")
@click.option('--test_ck', type=click.Choice(['last', 'best'], case_sensitive=False), default="best")
@click.option('--conf_file_path', type=str, default=None)
@click.option('--seed', type=int, default=6969)
...
def init_process(rank, size, host, port, backend='gloo'):
