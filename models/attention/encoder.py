...
if __name__ == '__main__':
    ...
    s_emb = torch.ones(32, 12, 256, dtype=torch.long)  # (BS, SL, emb_dim)
    t_emb = torch.ones(32, 56, 512, dtype=torch.long)  # (BS, TL, emb_dim)

    e = TransformerEncoder(256)
    d = TransformerDecoder(512, enc_emb_dim=256)
