...
if __name__ == '__main__':
    ...
    with open("E:/M Tech/6. Seminar/latestCode/data/validation-gt.json") as f:
        gt_tracks = json.load(f)
    with open(f"E:/M Tech/6. Seminar/latestCode/log/7. seminar/{exp_name}/val_result.json") as f:
        results = json.load(f)
