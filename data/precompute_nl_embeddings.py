...
def compute_bert_embs(ds_root, mode='train'):
	...
	bert_model = AlbertModel.from_pretrained('/home/satudent/7. seminar/nlp/bert_ft_experimental')
...
if __name__ == '__main__':
	#sddsf = torch.torch.cuda.is_available()
	compute_bert_embs()
